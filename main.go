...
func main() {
	...
	http.HandleFunc("/api/chat/switch", handleChatSwitch)
	...
	http.HandleFunc("/api/chat/config/delete", handleChatConfigDelete)
	...
	http.HandleFunc("/api/startup/cache", handleStartupCache)
